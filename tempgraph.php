...
<div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li><a href="tempgraph.php" class="active"><img class="sidebaricon" src="https://puu.sh/Im2pg/1699a1b89e.png"><span>Temperature</span></a></li>
            </ul>
            <ul>
                ...
                ajax.onreadystatechange = function(){
                    if(this.readyState == 4 && this.status == 200){
                        ...
                        for(var i = numberOfIndexes-1 ; i >= 0 ; i--){
                            tempData.push(dbData[maxIndex - i - shiftIndex].temp);
                        ...
                        //     dbData[maxIndex - 5].temp,
                        //     dbData[maxIndex - 4].temp,
                        //     dbData[maxIndex - 3].temp,
                        //     dbData[maxIndex - 2].temp,
                        //     dbData[maxIndex - 1].temp,
                        //     dbData[maxIndex].temp];
